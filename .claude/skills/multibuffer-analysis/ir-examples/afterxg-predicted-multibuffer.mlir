...
module attributes {hacc.target = #hacc.target<"Ascend950PR_9579">} {
  func.func @chunk_dplr_fwd_kernel_o(%arg0: memref<?xi8>, %arg1: memref<?xi8>, %arg2: memref<?xf16> {tt.divisibility = 16 : i32, tt.tensor_kind = 0 : i32}, %arg3: memref<?xf16> {tt.divisibility = 16 : i32, tt.tensor_kind = 0 : i32}, %arg4: memref<?xf16> {tt.divisibility = 16 : i32, tt.tensor_kind = 0 : i32}, %arg5: memref<?xf16> {tt.divisibility = 16 : i32, tt.tensor_kind = 0 : i32}, %arg6: memref<?xf16> {tt.divisibility = 16 : i32, tt.tensor_kind = 0 : i32}, %arg7: memref<?xf16> {tt.divisibility = 16 : i32, tt.tensor_kind = 0 : i32}, %arg8: memref<?xf16> {tt.divisibility = 16 : i32, tt.tensor_kind = 1 : i32}, %arg9: i32, %arg10: i32, %arg11: i32, %arg12: i32, %arg13: i32, %arg14: i32, %arg15: i32) attributes {SyncBlockLockArgIdx = 0 : i64, WorkspaceArgIdx = 1 : i64, global_kernel = "local", mix_mode = "mix", parallel_mode = "simd"} {
    ...
    %slot19_0 = memref.al : memref<64x32xf16>
    %slot19_1 = memref.al : memref<64x32xf16>
    %slot22_0 = memref.al : memref<32x16xf16>
    %slot22_1 = memref.al : memref<32x16xf16>

    %counter = memref.alloca() : memref<1xindex>
    memref.store %c0, %counter[%c0] : memref<1xindex>

    %21 = scf.for %arg16 = %c0_i32 to %c4_i32 step %c1_i32 iter_args(%arg17 = %1) -> (tensor<64x16xf32>) : i32 {
      %iter = memref.load %counter[%c0] : memref<1xindex>
      %idx = arith.remsi %iter, %c2 : index
      %is_slot1 = arith.cmpi eq, %idx, %c1 : index
      %alloc_19 = arith.select %is_slot1, %slot19_1, %slot19_0 : memref<64x32xf16>
      %alloc_22 = arith.select %is_slot1, %slot22_1, %slot22_0 : memref<32x16xf16>
      ...
      %98 = arith.subi %92, %14 : index
      %99 = arith.divsi %98, %c1024 : index
      %100 = arith.subi %91, %99 : index
      %101 = arith.maxsi %100, %c0 : index
      %102 = arith.minsi %101, %c64 : index
      %103 = arith.remsi %98, %c1024 : index
      %104 = arith.subi %c128, %103 : index
      %105 = arith.maxsi %104, %c0 : index
      %106 = arith.minsi %105, %c32 : index
      %107 = arith.subi %c0_i32, %15 : i32
      %108 = arith.maxsi %107, %c0_i32 : i32
      %109 = arith.index_cast %108 : i32 to index
      %110 = arith.minsi %109, %102 : index
      %111 = arith.subi %102, %110 : index
      %112 = arith.subi %c0_i32, %84 : i32
      %113 = arith.maxsi %112, %c0_i32 : i32
      %114 = arith.index_cast %113 : i32 to index
      %115 = arith.minsi %114, %106 : index
      %116 = arith.subi %106, %115 : index
      %117 = arith.cmpi slt, %111, %c64 : index
      %118 = arith.cmpi slt, %116, %c32 : index
      %119 = arith.ori %117, %118 : i1
      scf.if %119 {
        linalg.fill ins(%cst : f16) outs(%alloc_19 : memref<64x32xf16>)
      } {hivm.unlikely_condition}
      %subview_20 = memref.subview %reinterpret_cast_17[0, 0] [%111, %116] [1, 1] : memref<64x32xf16, strided<[1024, 1], offset: ?>> to memref<?x?xf16, strided<[1024, 1], offset: ?>>
      %subview_21 = memref.subview %alloc_19[%110, %115] [%111, %116] [1, 1] : memref<64x32xf16> to memref<?x?xf16, strided<[32, 1], offset: ?>>
      memref.copy %subview_20, %subview_21 : memref<?x?xf16, strided<[1024, 1], offset: ?>> to memref<?x?xf16, strided<[32, 1], offset: ?>>
      %120 = bufferization.to_tensor %alloc_19 restrict writable : memref<64x32xf16>
      %121 = arith.subi %97, %19 : index
      %122 = arith.divsi %121, %c128 : index
      %123 = arith.subi %c128, %122 : index
      %124 = arith.maxsi %123, %c0 : index
      %125 = arith.minsi %124, %c32 : index
      %126 = arith.remsi %121, %c128 : index
      %127 = arith.subi %c128, %126 : index
      %128 = arith.maxsi %127, %c0 : index
      %129 = arith.minsi %128, %c16 : index
      %130 = arith.minsi %114, %125 : index
      %131 = arith.subi %125, %130 : index
      %132 = arith.subi %c0_i32, %20 : i32
      %133 = arith.maxsi %132, %c0_i32 : i32
      %134 = arith.index_cast %133 : i32 to index
      %135 = arith.minsi %134, %129 : index
      %136 = arith.subi %129, %135 : index
      %137 = arith.cmpi slt, %131, %c32 : index
      %138 = arith.cmpi slt, %136, %c16 : index
      %139 = arith.ori %137, %138 : i1
      scf.if %139 {
        linalg.fill ins(%cst : f16) outs(%alloc_22 : memref<32x16xf16>)
      } {hivm.unlikely_condition}
      %subview_23 = memref.subview %reinterpret_cast_18[0, 0] [%131, %136] [1, 1] : memref<32x16xf16, strided<[128, 1], offset: ?>> to memref<?x?xf16, strided<[128, 1], offset: ?>>
      %subview_24 = memref.subview %alloc_22[%130, %135] [%131, %136] [1, 1] : memref<32x16xf16> to memref<?x?xf16, strided<[16, 1], offset: ?>>
      memref.copy %subview_23, %subview_24 : memref<?x?xf16, strided<[128, 1], offset: ?>> to memref<?x?xf16, strided<[16, 1], offset: ?>>
      %140 = bufferization.to_tensor %alloc_22 restrict writable : memref<32x16xf16>
      %141 = linalg.matmul {input_precision = "ieee"} ins(%120, %140 : tensor<64x32xf16>, tensor<32x16xf16>) outs(%arg17 : tensor<64x16xf32>) -> tensor<64x16xf32>

      %next_iter = arith.addi %iter, %c1 : index
      memref.store %next_iter, %counter[%c0] : memref<1xindex>

      scf.yield %141 : tensor<64x16xf32>
    }
    ...
    %alloc = memref.al : memref<64x64xf16>
    ...
    %alloc_7 = memref.al : memref<64x64xf16>
    scf.if %55 {
    ...
    %alloc_10 = memref.al : memref<64x16xf16>
    ...
    %alloc_13 = memref.al : memref<64x16xf16>
    scf.if %78 {
