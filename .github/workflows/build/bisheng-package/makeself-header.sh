...
EOLSM
	...
	shift
	break ;;
    # ASCEND_RUN_PACKAGE extensions: forward the installer's own options to
    # the embedded install.sh, mirroring the custom header of the original
    # Huawei-built ascendnpu-ir packages.
    --install|--run|--full|--uninstall|--upgrade|--install-for-all|--version)
