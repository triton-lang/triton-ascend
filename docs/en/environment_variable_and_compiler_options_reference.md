...
| **Debugging and logging**| TRITON_DISABLE_LINE_INFO | **1** (enabled)| Specifies whether to remove line information from the module. Enabled by default in triton-ascend.| **0**: Keep line information.<br>**1**: Remove line information.| |
