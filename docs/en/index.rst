...
.. toctree::
    :maxdepth: 2
    :caption: Architecture Design and Core Features
...
.. toctree::
    :maxdepth: 2
    :caption: Triton Operator Migration Guide
...
.. toctree::
    ...
    examples/09_costmodel_example.md
