...
def install() -> None:
    ...
    _ir_stub = _AutoModule("triton._C.libtriton.ir")
    _ir_stub.__package__ = "triton._C.libtriton.ir"
    _ir_stub.__path__ = []

    class _ir_builder:
        pass

    _ir_stub.builder = _ir_builder
    sys.modules["triton._C.libtriton.ir"] = _ir_stub
