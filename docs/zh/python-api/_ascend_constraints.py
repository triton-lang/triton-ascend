...
CONSTRAINTS = {
    ...
    "triton.extension.buffer.language.fixpipe": {
        "replace_docstring": [
            ...
            "Fixpipe is a pipeline that performs data movement from L0C to other",
            "memory hierarchies. Currently supports L0C to UB (Ascend 950 series).",
            "",
            ":param src: the source tensor. Must be the result of a dot operation",
            "    and located in the L0C memory region.",
            ":type src: tl.tensor",
            ":param dst: the destination buffer in UB. If None, an empty tensor",
            "    will be created.",
            ...
            "",
            ":note: The other two enums FixpipePreQuantMode (NO_QUANT, F322BF16,",
