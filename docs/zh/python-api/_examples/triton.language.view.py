...
@triton.jit
def view_kernel(x_ptr, out_ptr, D1: tl.constexpr, D2: tl.constexpr, D3: tl.constexpr, R1: tl.constexpr,
                R2: tl.constexpr):
    # (D1, D2, D3) viewed as (R1, R2)
...
def test_view():
    ...
    view_kernel[(1, )](x, out, D1, D2, D3, R1, R2)
