...
struct TestAxisInfoPass : public PassWrapper<TestAxisInfoPass, OperationPass<ModuleOp>> {
    ...
    StringRef getDescription() const final { return "print the result of the alignment analysis pass"; }
...
{
    PassRegistration<TestAxisInfoPass>();
}
} // namespace test
} // namespace mlir
