...
struct DecomposeUnsupportedAMDConversions
    : public mlir::triton::impl::DecomposeUnsupportedAMDConversionsBase<DecomposeUnsupportedAMDConversions> {
    explicit DecomposeUnsupportedAMDConversions(StringRef targetArch) { this->arch = targetArch.str(); }
    ...
    void runOnOperation() override
    {
        ...
        triton::gpu::decomposeTensorCoreToDotLayoutConversion(mod, isMfmaToDotShortcut);
        ...
        mod.walk([&](triton::gpu::ConvertLayoutOp cvtOp) -> void {
            ...
            auto srcWmma = dyn_cast<triton::gpu::AMDWmmaEncodingAttr>(srcType.getEncoding());
            ...
            if (srcWmma && dstDotOp) {
                ...
                auto tmp = builder.create<triton::gpu::ConvertLayoutOp>(cvtOp.getLoc(), tmpType, cvtOp.getOperand());
    ...
    //
        ...
        mod.walk([&](triton::gpu::ConvertLayoutOp cvtOp) -> void {
            ...
            auto replacementCvts = mlir::triton::AMD::createNewConvertOps(builder, cvtOp, tmpLayouts[minIdx]);
...
std::unique_ptr<OperationPass<ModuleOp>> createDecomposeUnsupportedConversionsPass(StringRef targetArch)
{
