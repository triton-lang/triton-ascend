...
GCNInstr::Operand *GCNBuilder::newOperand(mlir::Value value, StringRef constraint,
...
mlir::Value GCNBuilder::launch(ConversionPatternRewriter &rewriter, Location loc, Type resTy, bool hasSideEffect,
                               bool isAlignStack, ArrayRef<Attribute> attrs) const
{
...
GCNInstr::Operand *GCNBuilder::newAddrOperand(mlir::Value addr, StringRef constraint)
{
...
{
    builder->executions.emplace_back(std::make_unique<GCNInstrExecution>(this, oprs, mods));
...
SmallVector<GCNInstrExecution::Operand *> GCNInstrExecution::getArgList() const
{
