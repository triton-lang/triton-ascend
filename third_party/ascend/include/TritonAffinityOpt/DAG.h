...
enum CoreType { UNDETERMINED = 0, VECTOR_ONLY = 1 << 0, CUBE_ONLY = 1 << 1, CUBE_AND_VECTOR = VECTOR_ONLY | CUBE_ONLY };
...
class Graph : MoveOnly {
  public:
    ...
    Graph(Block *block, Graph *parent = nullptr, OpMap opMap = nullptr, ValueMap valueMap = nullptr,
