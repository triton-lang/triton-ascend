...
// transformation after the unroll is written against a live `scf.for` body, so the pass
...
// DIAG: [cv-split] Unroll consumes the whole trip count; keeping a single-iteration loop for the remaining phases
