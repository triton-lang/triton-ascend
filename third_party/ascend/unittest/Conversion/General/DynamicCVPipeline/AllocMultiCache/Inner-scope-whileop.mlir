...
// arith.addi increment for the multi-buffer counter is present (block_id=10).
// CHECK:       %{{.+}} = arith.addi %{{.+}}, %{{.+}} {ssbuffer.block_id = 10 : i32} : i32
// Original main_loop attribute survives on the new whileOp.
// CHECK:       } {{.*}}ssbuffer.main_loop = 1 : i64
