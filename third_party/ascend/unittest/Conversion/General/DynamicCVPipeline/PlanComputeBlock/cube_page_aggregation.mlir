// RUN: triton-opt --split-input-file --enable-cube-block-merge --op-classifier %s | FileCheck %s --check-prefixes=ON,COMMON
// RUN: triton-opt --split-input-file --op-classifier %s | FileCheck %s --check-prefixes=OFF,COMMON
// RUN: triton-opt --split-input-file --enable-cube-block-merge --plan-compute-block --compute-block-opt --verify-each %s | FileCheck %s --check-prefixes=MATERIAL,COMMON
...
// ON-DAG: memref.load {{.*}}ssbuffer.core_type = "CUBE"
// ON-DAG: arith.andi {{.*}}ssbuffer.core_type = "CUBE"
// ON-DAG: arith.shrsi {{.*}}ssbuffer.core_type = "CUBE"
// ON-DAG: memref.copy {{.*}}ssbuffer.core_type = "CUBE"
// ON-DAG: memref.copy {{.*}}ssbuffer.core_type = "CUBE"
// ON-DAG: tensor.insert_slice {{.*}}ssbuffer.core_type = "CUBE"
// ON-DAG: tensor.insert_slice {{.*}}ssbuffer.core_type = "CUBE"
// OFF-DAG: memref.load {{.*}}ssbuffer.core_type = "VECTOR"
// OFF-DAG: arith.andi {{.*}}ssbuffer.core_type = "VECTOR"
// OFF-DAG: arith.shrsi {{.*}}ssbuffer.core_type = "VECTOR"
// OFF-DAG: memref.copy {{.*}}ssbuffer.core_type = "VECTOR"
// OFF-DAG: memref.copy {{.*}}ssbuffer.core_type = "VECTOR"
// OFF-DAG: tensor.insert_slice {{.*}}ssbuffer.core_type = "VECTOR"
// OFF-DAG: tensor.insert_slice {{.*}}ssbuffer.core_type = "VECTOR"
