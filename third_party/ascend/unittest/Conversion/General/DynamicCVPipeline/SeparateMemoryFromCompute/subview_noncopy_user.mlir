...
module {
  func.func @subview_noncopy_users(%arg0: memref<?xf16>, %arg1: i64) {
    ...
    %tensor = bufferization.to_tensor %subview restrict writable {ssbuffer.block_id = 10 : i32} : memref<1x32xf16, strided<[32, 1], offset: ?>> to tensor<1x32xf16>
    ...
    %loaded = bufferization.to_tensor %subview_2 restrict writable {ssbuffer.block_id = 10 : i32} : memref<1x32xf16, strided<[32, 1], offset: ?>> to tensor<1x32xf16>
