...
module {
  func.func @test_refine_args_block_id() {
    ...
    %alloc_0 = memref.alloc() {ssbuffer.block_id = 6 : i32} : memref<32x32xf32>
    %alloc_1 = memref.alloc() {ssbuffer.block_id = 8 : i32} : memref<32x32xf32>
    %tensor_0 = bufferization.to_tensor %alloc_0 restrict writable {ssbuffer.block_id = 6 : i32} : memref<32x32xf32> to tensor<32x32xf32>
    %tensor_1 = bufferization.to_tensor %alloc_1 restrict writable {ssbuffer.block_id = 8 : i32} : memref<32x32xf32> to tensor<32x32xf32>
