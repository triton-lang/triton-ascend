...
// CHECK: scf.for {{.*}} iter_args({{.*}}, %[[ARG_3:[a-z0-9_]+]] = %[[EXP_2]])
// CHECK: arith.constant

// CHECK: hivm.hir.sync_block_wait
// CHECK: hivm.hir.copy ins(%[[ARG_3]] : tensor<32xf32>) outs(%[[ALLOC]] : memref<32xf32, #hivm.address_space<cbuf>>)
// CHECK: hivm.hir.sync_block_set
...
// CHECK: linalg.matmul {{.*}} ins({{.*}}) outs(%[[BROADCASTED]] : tensor<32x32xf32>)
// CHECK: hivm.hir.sync_block_set
