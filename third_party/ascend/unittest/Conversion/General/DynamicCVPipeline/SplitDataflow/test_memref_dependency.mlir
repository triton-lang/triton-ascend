...
// CHECK: hivm.hir.sync_block_set {{.*}}[<VECTOR>, <PIPE_MTE3>, <PIPE_MTE2>]
// CHECK: hivm.hir.sync_block_wait {{.*}}[<CUBE>, <PIPE_MTE3>, <PIPE_MTE2>]
...
// CHECK: hivm.hir.sync_block_set {{.*}}[<CUBE>, <PIPE_FIX>, <PIPE_MTE2>]
// CHECK: hivm.hir.sync_block_wait {{.*}}[<VECTOR>, <PIPE_FIX>, <PIPE_MTE2>]
// CHECK: memref.copy
// CHECK: return
