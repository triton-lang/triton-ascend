// RUN: triton-opt %s --verify-each -graph-optimize='rule-mask=65536 ub-capacity-bytes=157286 compile-mode=simd' | FileCheck %s --check-prefix=DISABLED
// RUN: triton-opt %s --verify-each -graph-optimize='target-arch=Ascend910_9589 rule-mask=65536 ub-capacity-bytes=157286 compile-mode=simd' | FileCheck %s --check-prefix=DISABLED
// RUN: triton-opt %s --verify-each -graph-optimize='target-arch=Ascend950 rule-mask=65536 ub-capacity-bytes=157286 compile-mode=simd' | FileCheck %s --check-prefix=DISABLED
// RUN: triton-opt %s --verify-each -graph-optimize='target-arch=unknown rule-mask=65536 ub-capacity-bytes=157286 compile-mode=simd' | FileCheck %s --check-prefix=DISABLED
...
// RUN: triton-opt %s --verify-each -graph-optimize='target-arch=Ascend910B1 rule-mask=65536 ub-capacity-bytes=157286' | FileCheck %s
// RUN: triton-opt %s --verify-each -graph-optimize='target-arch=Ascend910B1 rule-mask=65536 ub-capacity-bytes=157286 compile-mode=simd_simt_template' | FileCheck %s
// RUN: triton-opt %s --verify-each -graph-optimize='target-arch=Ascend910B1 rule-mask=65536 ub-capacity-bytes=157286 compile-mode=unstructured_in_simt' | FileCheck %s
// RUN: triton-opt %s --verify-each -graph-optimize='target-arch=Ascend910_9589 rule-mask=65536 ub-capacity-bytes=157286 compile-mode=simt_only' | FileCheck %s --check-prefix=DISABLED
// RUN: triton-opt %s --verify-each -graph-optimize='target-arch=Ascend910_9391 rule-mask=65536 ub-capacity-bytes=157286' | FileCheck %s
// RUN: triton-opt %s --verify-each -graph-optimize='target-arch=Ascend910A rule-mask=65536 ub-capacity-bytes=157286' | FileCheck %s --check-prefix=DISABLED
// RUN: triton-opt %s --verify-each -graph-optimize='target-arch=Ascend910D rule-mask=65536 ub-capacity-bytes=157286' | FileCheck %s --check-prefix=DISABLED
// RUN: triton-opt %s --verify-each -graph-optimize='target-arch=Ascend310B1 rule-mask=65536 ub-capacity-bytes=157286' | FileCheck %s --check-prefix=DISABLED
