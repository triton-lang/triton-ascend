...
// Case 3: Scalar / splat other=0.0 with a runtime length. Not a compile-time
// prefix, so dest-alloc fill (insert_slice is only for static K-pad like GLA).
...
module attributes {hacc.target = #hacc.target<"Ascend910B4">} {
  tt.func public @load_other_scalar_zero_full_use(%arg0: !tt.ptr<f32> {tt.divisibility = 16 : i32}, %arg1: !tt.ptr<f32> {tt.divisibility = 16 : i32}) attributes {noinline = false} {
    ...
    %5 = tt.splat %c32_i32 : i32 -> tensor<64xi32>
    %6 = arith.cmpi slt, %2, %5 : tensor<64xi32>
...
// Case 6: 2-D GLA tile. 16x64 dest, last dim live size is 32 (K=32, BK=64).
...
module attributes {hacc.target = #hacc.target<"Ascend910B4">} {
  tt.func public @load_other_scalar_zero_2d_gla_tile(%arg0: !tt.ptr<f32> {tt.divisibility = 16 : i32}, %arg1: !tt.ptr<f32> {tt.divisibility = 16 : i32}, %arg2: i32) attributes {noinline = false} {
    ...
    %c32_i32 = arith.constant 32 : i32
    %k = tt.splat %c32_i32 : i32 -> tensor<64xi32>
