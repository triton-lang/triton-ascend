...
def acf02_tc01_outer_cv_pure_cube(
    a_ptr, b_ptr, c_ptr, d_ptr, out_ptr, out2_ptr,
    M, N, K,
    stride_am, stride_ak,
    stride_bk, stride_bn,
    stride_c, stride_d,
    stride_out, stride_out2_0, stride_out2_1,
...
def test_acf02_tc01():
    """ACF02-TC01: 验证float16 kernel编译生成的MLIR代码正确性。"""
    signature = {
        "a_ptr": "*fp16",
        "b_ptr": "*fp16",
        "c_ptr": "*fp16",
...
def test_acf02_tc02():
    """ACF02-TC02: 验证float32 kernel编译生成的MLIR代码正确性。"""
    signature = {
        "a_ptr": "*fp32",
        "b_ptr": "*fp32",
        "c_ptr": "*fp32",
