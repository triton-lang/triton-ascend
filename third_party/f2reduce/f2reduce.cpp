...
void swap_rows(uint64_t *RESTRICT x, uint64_t *RESTRICT y, uint64_t n) {
...
template <uint64_t N>
NO_INLINE void memxor_lop3(uint64_t *RESTRICT dst,
...
template <uint64_t N>
void memxor_inplace(uint64_t *RESTRICT dst, const uint64_t *RESTRICT src1,
                    const uint64_t *RESTRICT src2) {
  for (uint64_t i = 0; i < N; i++) {
    dst[i] = src1[i] ^ src2[i];
  }
 ...
 */
template <uint64_t N>
void kronrod(uint64_t *RESTRICT matrix, uint64_t rows, uint64_t stride,
             const uint64_t *RESTRICT workspace, uint64_t *RESTRICT cache,
             const uint64_t *RESTRICT pivots, int k) {
 ...
 */
void chunked_kronrod(const uint64_t *RESTRICT pivots, uint64_t *RESTRICT matrix,
                     uint64_t rows, uint64_t strips, uint64_t stride,
 ...
 */
bool perform_K_steps(uint64_t *RESTRICT matrix, uint64_t *RESTRICT stripspace,
                     uint64_t rows, uint64_t strips, uint64_t stride,
...
void inplace_rref_strided_K(uint64_t *RESTRICT matrix,
                            ...
                            uint64_t cols, uint64_t stride, uint64_t *workspace,
                            uint64_t *cache, int K) {
