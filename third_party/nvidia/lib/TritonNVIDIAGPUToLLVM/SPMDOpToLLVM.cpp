...
struct GetNumProgramsOpConversion : public ConvertOpToLLVMPattern<triton::GetNumProgramsOp> {
...
struct GetCanonicalWarpIdConversion : public ConvertOpToLLVMPattern<triton::nvidia_gpu::GetCanonicalWarpIdOp> {
    using ConvertOpToLLVMPattern<triton::nvidia_gpu::GetCanonicalWarpIdOp>::ConvertOpToLLVMPattern;
    LogicalResult matchAndRewrite(triton::nvidia_gpu::GetCanonicalWarpIdOp op, OpAdaptor adaptor,
                                  ConversionPatternRewriter &rewriter) const override
    {
        auto warpIdOp = rewriter.create<triton::nvgpu::CanonicalWarpIdOp>(op->getLoc(), rewriter.getI32Type());
...
void mlir::triton::NVIDIA::populateSPMDOpToLLVMPattern(LLVMTypeConverter &typeConverter, RewritePatternSet &patterns,
