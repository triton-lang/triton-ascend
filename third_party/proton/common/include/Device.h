...
enum class DeviceType { HIP, CUDA, NPU, COUNT };
...
template <> struct DeviceTraits<DeviceType::NPU> {
  constexpr static DeviceType type = DeviceType::NPU;
  constexpr static const char *name = "NPU";
};
