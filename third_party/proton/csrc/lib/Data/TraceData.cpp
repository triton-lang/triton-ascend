...
void TraceData::startOp(const Scope &scope)
{
    throw NotImplemented();
}

void TraceData::stopOp(const Scope &scope)
{
    throw NotImplemented();
}
...
void TraceData::addMetrics(size_t scopeId, const std::map<std::string, MetricValueType> &metrics, bool aggregable)
{
    throw NotImplemented();
}
