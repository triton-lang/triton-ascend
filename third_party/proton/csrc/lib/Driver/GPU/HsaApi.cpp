...
DEFINE_DISPATCH(ExternLibHsa, agentGetInfo, hsa_agent_get_info, hsa_agent_t, hsa_agent_info_t, void *);
...
hsa_status_t iterateAgents(hsa_status_t (*callback)(hsa_agent_t agent, void *data), void *data)
{
    ...
    if (func == nullptr)
        func = reinterpret_cast<hsa_iterate_agents_t>(dlsym(ExternLibHsa::lib, "hsa_iterate_agents"));
